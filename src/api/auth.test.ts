...
describe('authApi', () => {
  ...
  it('reuses the in-memory authenticated user without rotating the refresh cookie', async () => {
    ...
    expect(JSON.stringify(window.sessionStorage)).not.toContain('issued-access-token')
  })
