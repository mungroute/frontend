...
import { ShadeMapOverlay, ShadeTimelineChart } from '../Components/courses/CourseVisuals'
...
export function ShadeTimelinePage({ map, onBack, onWalkAtRecommended }: ShadeTimelinePageProps) {
  return (
    <main className="journey-page extended-management-page shade-timeline-page">
      ...
      <BaseMapViewport className="shade-timeline-page__map" ariaLabel="코스 구간별 그늘 지도" map={map} fallback={{ src: '/assets/s09/map.jpg', overlay: <ShadeMapOverlay /> }} />
